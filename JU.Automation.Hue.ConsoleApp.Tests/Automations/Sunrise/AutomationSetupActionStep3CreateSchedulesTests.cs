...
public class AutomationSetupActionStep3CreateSchedulesTests
{
        ...
        string sunriseTransitionUpScheduleId, string sunriseTurnOffScheduleId)
    {
        ...
        var nameTransitionUp = $"{Constants.Automation.Sunrise}1{Constants.Entity.Schedule}{Constants.Stage.TransitionUp}";
        var nameTurnOff = $"{Constants.Automation.Sunrise}1{Constants.Entity.Schedule}{Constants.Stage.TurnOff}";
